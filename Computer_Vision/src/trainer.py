...
from stroke_recognition import GRU_model
...
class Trainer:
    ...
    def __init__(self, model, train_dl, valid_dl, lr=0.001, reg=0.003):
        ...
        self.saved_state_name = f'saved_state_thetis_GRU_{lr}_{reg}_'
...
def train_thetis():
    ...
    train_ds, valid_ds, test_ds = create_train_valid_test_datasets('./dataset/VIDEO_RGB/THETIS_data.csv',
                                                                   './dataset/features/',
                                                                   )
